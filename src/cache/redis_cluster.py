...
class RedisClusterClient:
    """Production-grade async Redis cluster client with reconnection and health checks."""
    ...
    async def connect(self) -> bool:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                logger.warning(f"Redis cluster connection attempt {attempt + 1}/{self.max_retries} failed: {e}")
                if attempt < self.max_retries - 1:
                    await asyncio.sleep(self.retry_delay * (attempt + 1))
                else:
                    logger.error(f"Redis cluster connection failed after {self.max_retries} attempts: {e}")
    ...
    async def disconnect(self):
        """Clean up Redis cluster connection."""
        ...
        if self.client:
            try:
                ...
                logger.error(f"Error closing Redis cluster client: {e}")
            finally:
                self.client = None
        ...
        if self.pool:
            try:
                ...
                logger.error(f"Error disconnecting cluster pool: {e}")
            finally:
                self.pool = None
    ...
    async def _health_check_loop(self):
        ...
        while True:
            try:
                ...
                logger.error(f"Redis cluster health check error: {e}")
    ...
    async def set(self, key: str, value: str, expire: int = None) -> bool:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                logger.warning(f"Redis cluster set attempt {attempt + 1} failed: {e}")
                if attempt < self.max_retries - 1:
                    await asyncio.sleep(self.retry_delay)
                else:
                    logger.error(f"Redis cluster set error after {self.max_retries} attempts: {e}")
                    return False
        return False
    ...
    async def get(self, key: str) -> Optional[str]:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                logger.warning(f"Redis cluster get attempt {attempt + 1} failed: {e}")
                if attempt < self.max_retries - 1:
                    await asyncio.sleep(self.retry_delay)
                else:
                    logger.error(f"Redis cluster get error after {self.max_retries} attempts: {e}")
                    return None
        return None
    ...
    async def delete(self, key: str) -> bool:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                logger.warning(f"Redis cluster delete attempt {attempt + 1} failed: {e}")
                if attempt < self.max_retries - 1:
                    await asyncio.sleep(self.retry_delay)
                else:
                    logger.error(f"Redis cluster delete error after {self.max_retries} attempts: {e}")
                    return False
        return False
    ...
    async def delete_pattern(self, pattern: str) -> int:
        ...
        try:
            ...
            logger.error(f"Redis cluster delete_pattern error: {e}")
            return 0
    ...
    async def get_json(self, key: str) -> Optional[dict]:
        ...
        try:
            ...
            logger.error(f"Redis cluster get_json JSON decode error: {e}")
            return None
    ...
    async def expire(self, key: str, seconds: int) -> bool:
        ...
        try:
            ...
            logger.error(f"Redis cluster expire error: {e}")
            return False
    ...
    async def ttl(self, key: str) -> int:
        ...
        try:
            ...
            logger.error(f"Redis cluster ttl error: {e}")
            return -2
    ...
    async def decr(self, key: str, amount: int = 1) -> Optional[int]:
        ...
        try:
            ...
            logger.error(f"Redis cluster decr error: {e}")
            return None
    ...
    async def get_many(self, keys: List[str]) -> Dict[str, Optional[str]]:
        ...
        try:
            ...
            logger.error(f"Redis cluster get_many error: {e}")
            return {k: None for k in keys}
    ...
    async def set_many(self, mapping: Dict[str, str], expire: int = None) -> bool:
        ...
        try:
            ...
            logger.error(f"Redis cluster set_many error: {e}")
            return False
    ...
    async def get_info(self) -> Optional[dict]:
        ...
        try:
            ...
            logger.error(f"Redis cluster get_info error: {e}")
            return None
